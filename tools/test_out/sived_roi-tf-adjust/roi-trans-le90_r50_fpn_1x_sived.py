...
launcher = 'none'
load_from = 'weights/FSModel/ROI-Transformer-Adjust.pth'
log_level = 'INFO'
...
model = dict(
    ...
    init_cfg=dict(
        checkpoint='weights/FSModel/ROI-Transformer.pth', type='Pretrained'),
    neck=dict(
        in_channels=[
            256,
            512,
...
work_dir = 'tools/test_out/sived_roi-tf-adjust/'
