...
launcher = 'none'
load_from = 'weights/FSModel/Rotated-FCOS-Adjust.pth'
log_level = 'INFO'
...
model = dict(
    ...
    init_cfg=dict(
        checkpoint='weights/FSModel/Rotated-FCOS.pth', type='Pretrained'),
    neck=dict(
...
work_dir = 'tools/test_out/sived_rotated-faster-rcnn/'
